...
//   return (
//     <div className="fixed md:static top-0 right-0 w-full md:w-[430px] h-full bg-white shadow-2xl border-l border-gray-200 z-50 animate-slide-in">
//       {/* Header */}
...
//       {/* Scrollable Content */}
//       <div className="p-5 overflow-y-auto h-[calc(100%-70px)] space-y-4">
...
//         {/* Visa */}
//         <div className="mt-3">
//           <h5 className="text-sm font-semibold text-gray-900 mb-2">Visa Support</h5>
//           <div className="flex flex-wrap gap-2">
//             {job.visas?.map((v, i) => (
//               <span
//                 key={i}
//                 className="px-3 py-1 bg-purple-50 text-purple-700 border border-purple-200 rounded-full text-xs"
//               >
//                 {v}
//               </span>
//             ))}
...
//             🚧 Real description will come from backend, but this is placeholder content to match layout. 
//             This position involves working on technical tasks, collaborating with teammates, and delivering results.
//           </p>
//         </div>

//         {/* Apply / Save */}
//         <div className="flex gap-3 mt-4">
//           <button className="flex-1 py-2 bg-purple-600 text-white rounded-lg font-semibold hover:bg-purple-700">
//             Apply Now
//           </button>
//           <button className="flex-1 py-2 border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50">
//             Save Job
//           </button>
//         </div>
//       </div>
  ...
  return (
    <div className="fixed md:static top-0 right-0 w-full md:w-[430px] h-full bg-white shadow-2xl border-l border-gray-200 z-50 animate-slide-in flex flex-col">
      ...
      <div className="border-t px-5 py-3 bg-white flex gap-3">
        ...
        <button
          onClick={handleSave}
          className={`flex-1 py-2 flex items-center justify-center gap-2 rounded-lg border text-sm font-medium transition ${
            isSaved
        ...
        <button
          ...
          className={`flex-1 py-2 rounded-lg text-white text-sm font-semibold transition ${
            isApplied ? "bg-green-600" : "bg-purple-600 hover:bg-purple-700"
          }`}
        >
